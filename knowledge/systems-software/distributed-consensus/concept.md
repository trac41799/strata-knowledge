...
- Failure models: crash (fail-stop) faults mean a process simply stops and never resumes — the model FLP's impossibility is stated for [T0][S-0034]. Byzantine faults mean a node may behave arbitrarily (lie, equivocate, send conflicting messages) due to bugs or attacks — the failure class PBFT is designed to tolerate [T1][S-0037].
